...
%\usepackage[style=numeric-comp, sorting=none, alldates=short, abbreviate=false, maxcitenames=2, maxbibnames=99, eprint=false, hyperref=auto, backend=bibtex]{biblatex} 
